...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\wamp\\www\\tcc\\log/intranet_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\wamp\\www\\tcc\\cache\\intranet\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\wamp\\www\\tcc\\apps\\intranet/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\wamp\\www\\tcc\\cache\\intranet\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\wamp\\www\\tcc\\apps\\intranet/template',
)));
